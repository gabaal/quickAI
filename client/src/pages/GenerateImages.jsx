...
const GenerateImages = () => {
  ...
  const imageStyle = [
        'Realistic', 'Cartoon', 'Abstract', 'Vintage', 'Modern', 'Fantasy', 'Sci-Fi', 'Nature', 'Urban', 'Minimalist', 'Anime', 'Surreal', 'Pop Art', 'Impressionist', 'Expressionist', 'Gothic', 'Cyberpunk', 'Steampunk', 'Art Deco', 'Baroque'
      ]
...
<label className="relative cursor-pointer"><input type="checkbox" onChange={(e)=>setPublish(e.target.checked)} checked={publish} className="sr-only peer" />
      ...
      <div className="w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96">
        ...
        <div className="flex-1 flex justify-center items-center">
          <div className="text-sm flex flex-col items-center gap-5 text-gray-400">
            ...
            <p className="">Enter description and click 'Generate Image' to get started</p>
          </div>
        </div>
      </div>
    </div>
